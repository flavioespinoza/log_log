    ...
    render: function render(text, _ref10) {
        var _ref10$engine = _ref10.engine,
            ...
            ansi: function ansi(s) {
                return _f31‍.g.console[consoleMethod](s);
            },
            chrome: function chrome(s) {
                var _console;

                return (_console = _f31‍.g.console)[consoleMethod].apply(_console, _toConsumableArray(ansi.parse(s).asChromeConsoleLogArguments));
            },
            generic: function generic(s) {
                return _f31‍.g.console[consoleMethod](ansi.strip(s));
            }
        } : _ref10$defaults;
